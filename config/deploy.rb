...
role :web, "jasonl_biz.com"                          # Your HTTP server, Apache/etc
role :app, "jasonl_biz.com"                         # This may be the same as your `Web` server
role :db,  "jasonl_biz.com"   , :primary => true # This is where Rails migrations will run
